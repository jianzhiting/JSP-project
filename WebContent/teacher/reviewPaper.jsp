...
%>
	<div id="table">
		<table>
			...
			<%
			try {
				String sql = "select tb_paper.student_id,student_name,paper_item,paper_type,review_grade "+
					...
					"and review_teacher='"+id+"' and review_state!='2'";
				db.rs = db.stmt.executeQuery(sql);
				while(db.rs.next()){
					String review_grade = "";
					if(db.rs.getString(5) != null)
						review_grade = db.rs.getString(5).toString();
			...
			<tr>
			  ...
			  <td  class="e">
				<form action="/project/teaReview?student_id=<%=db.rs.getString(1)%>" method="post">
			        <input type="text" name="review_grade" class="paper" placeholder="输入评分" value="<%=review_grade%>">
